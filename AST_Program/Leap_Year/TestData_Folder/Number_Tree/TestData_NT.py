...
def create_testdata():
    ...
    numbers = 50
    input_numbers = 1
    temp_input = temp_input = random.randint(1990,2100)
    temp_output = 0
    #
    for i in range(1, numbers + 1):
        input_data[str(i)] = []
        ...
        for j in range(1, input_numbers + 1):
            ...
            if (random.randint(1, 3) == 1):
                print('greater than')
                temp_input = random.randint(temp_input + random.randint(2, 10), temp_input + random.randint(12, 20))
            # less than
            elif (random.randint(1, 3) == 2):
                print('less than')
                temp_input = random.randint(temp_input - random.randint(12, 20), temp_input - random.randint(2, 10))
            # equal
            else:
                print('equal')
