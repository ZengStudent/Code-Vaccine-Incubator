...
def create_testdata():
    ...
    numbers = 50
    input_numbers = 3
    temp_input = random.randint(500, 1000)
    temp_output = 0
    #
    for i in range(1, numbers + 1):
        input_data[str(i)] = []
        ...
        # output_data
        temp_output = amutant.tri(input_data[str(i)][0], input_data[str(i)][1], input_data[str(i)][2])
...
def create_testcase():
    ...
    def test_tri(self):
        ...
        # part four
        part_four = '''tri(self.input_a,self.input_b,self.input_c),''' + '\'' + str(output_data[name]) + '\'' + ')'
        # part five
        part_five = '''\n            print('Pass')
            self.result='Pass'
