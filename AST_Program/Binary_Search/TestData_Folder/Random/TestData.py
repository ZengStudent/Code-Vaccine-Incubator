...
def create_testdata():
    ...
    for i in range(1, numbers + 1):
        ...
        # output_data
        temp_output = amutant.binary_search(input_data[str(i)],0,len(input_data[str(i)])-1,aim[str(i)])
...
def create_testcase():
    ...
    def test_tri(self):
        ...
        # part four
        part_four = '''binary_search(self.input_data,self.input_start,self.input_maxlen,self.aim),''' + str(output_data[name]) + ')'
        # part five
        part_five = '''\n            print('Pass')
            self.result='Pass'
