import os, shutil
import random
from AST_Program.Leap_Year.SourceCode import Leap_Year as amutant
...
def create_testdata():
    ...
    for i in range(1, numbers + 1):
        ...
        for j in range(1, input_numbers + 1):
            temp_input = random.randint(1990,2100)
            input_data[str(i)].append(temp_input)

        # output_data
        temp_output = amutant.leap(input_data[str(i)][0])
...
def create_testcase():
    ...
    def test_tri(self):
        ...
        # part four
        part_four = '''leap(self.input_a),''' + str(output_data[name]) + ')'
        # part five
        part_five = '''\n            print('Pass')
            self.result='Pass'
            ...
            #path = os.path.abspath(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))) + '\AST_TestCase_Result_Folder/AST_FOM_TestCase_Result_Folder/AST_FOM_TestCase_Result_Folder_'+ str(folder_numbers) + '/'
            #  新建資料夾
    ...
    '''
        ...
        def test_tri(self):
            ...
            part_five = '''\n                print('Pass')
                ...
                path = os.path.abspath(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))))) + '\AST_TestCase_Result_Folder/AST_HOM_TestCase_Result_Folder/AST_HOM_TestCase_Result_Folder_'+ str(folder_numbers) + '/'
