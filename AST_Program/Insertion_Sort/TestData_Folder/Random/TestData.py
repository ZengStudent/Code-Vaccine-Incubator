...
def create_testdata():
    ...
    for i in range(1, numbers + 1):
        ...
        for j in range(1, input_numbers + 1):
            temp_input = random.randint(50, 250)
            input_data[str(i)].append(temp_input)

        # output_data
        temp_store = copy.deepcopy(input_data)
        temp_output = amutant.insertionSort(temp_store[str(i)])
...
def create_testcase():
    ...
    def test_tri(self):
        ...
        # part four
        part_four = '''insertionSort(self.input_a),''' + str(output_data[name]) + ')'
        # part five
        part_five = '''\n            print('Pass')
            self.result='Pass'
...
if __name__ == '__main__':
    ...
    '''
        ...
        def test_tri(self):
            ...
            # part four
            part_four = '''insertionSort(self.input_a,self.input_b,self.input_c),''' + '\'' + str(output_data[name]) + '\'' + ')'
            # part five
            part_five = '''\n                print('Pass')
                self.result='Pass'
            except AssertionError:
