import os, shutil
import random
from AST_Program.Quick_Sort.SourceCode import Quick_Sort as amutant
...
def create_testdata():
    ...
    for i in range(1, numbers + 1):
        ...
        # output_data
        temp_output = amutant.quick_sort(input_data[str(i)])
...
def create_testcase():
    ...
    def test_tri(self):
        ...
        # part four
        part_four = '''quick_sort(self.input_a),''' + str(output_data[name]) + ')'
        # part five
        part_five = '''\n            print('Pass')
            self.result='Pass'
