...
def create_testdata():
    ...
    for i in range(1, numbers + 1):
        ...
        # output_data
        temp_output = amutant.linear_search(input_data[str(i)],aim[str(i)])
...
def create_testcase():
    ...
    def test_tri(self):
        ...
        # part four
        part_four = '''linear_search(self.input_data,self.input_start,self.input_maxlen,self.aim),''' + str(output_data[name]) + ')'
        # part five
        part_five = '''\n            print('Pass')
            self.result='Pass'
